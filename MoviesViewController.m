...
//    self.moviesTableView.rowHeight = 200;
...
//    UISegmentedControl* sgc = [[UISegmentedControl alloc] init];
    ...
    NSURLRequest* request = [[NSURLRequest alloc] initWithURL:url cachePolicy:NSURLCacheStorageAllowed timeoutInterval:5];
